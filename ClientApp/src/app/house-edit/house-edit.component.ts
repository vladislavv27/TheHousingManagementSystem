...
export class HouseEditComponent implements OnInit {
  ...
  async checkAndUpdateHouse(house:House) {
    const houseNumberToCheck = house.number;
    const existingHouse = await this.houseService.doesHouseExistByNumber(houseNumberToCheck);
    console.log(houseNumberToCheck);
    if (existingHouse) {
